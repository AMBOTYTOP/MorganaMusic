...
async def get_thumb(videoid):
    ...
    arial = ImageFont.truetype("MorganaMusic/assets/font2.ttf", 30)
    font = ImageFont.truetype("MorganaMusic/assets/font.ttf", 30)
    title_font = ImageFont.truetype("MorganaMusic/assets/font3.ttf", 45)
    ...
    play_icons = Image.open("MorganaMusic/assets/play_icons.png")
